...
int main()
{
	...
	if (ok)
		printf("Inseracao do aluno %4i retornou true.\t(OK)\n", nusp);
	else
		printf("Inseracao do aluno %4i retornou false.\t(NOK)\n", nusp);
	...
	ok = inserirAluno(&turma1, nusp, 100, 95);
	if (ok)
		printf("Inseracao do aluno %4i retornou true.\t(NOK)\n", nusp);
	else
		printf("Inseracao do aluno %4i retornou false.\t(OK)\n", nusp);
	...
	if (res)
		printf("Nota do aluno %i: %3i\n", nusp, res->aluno.nota);
	else
		printf("Aluno nao encontrado: '%i'\n", nusp);
	...
	if (ok)
		printf("A exclusao do aluno %i retornou true.\t(OK)\n", nusp);
	else
		printf("A exclusao do aluno %i retornou false.\t(NOK)\n", nusp);
	...
	ok = excluirAluno(&turma1, nusp);
	if (ok)
		printf("A exclusao do aluno %i retornou true.\t(NOK)\n", nusp);
	else
		printf("A exclusao do aluno %i retornou false.\t(OK)\n", nusp);
	...
	if (ok)
		printf("A insercao da nota da recuperacao do aluno %i retornou true.\t(NOK)\n", nusp);
	else
		printf("A insercao da nota da recuperacao do aluno %i retornou false.\t(OK)\n", nusp);
	...
	if (ok)
		printf("A insercao da nota da recuperacao do aluno %i retornou true.\t(OK)\n", nusp);
	else
		printf("A insercao da nota da recuperacao do aluno %i retornou false.\t(NOK)\n", nusp);
